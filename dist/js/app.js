...
/* harmony import */ var _scripts_all_tournaments_block__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scripts/all_tournaments_block */ "./src/scripts/all_tournaments_block.js");
/* harmony import */ var _scripts_single_tournament__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./scripts/single-tournament */ "./src/scripts/single-tournament.js");
/* harmony import */ var _scripts_single_tournament__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_scripts_single_tournament__WEBPACK_IMPORTED_MODULE_3__);
...
/***/ "./src/scripts/all_tournaments_block.js":
/*!**********************************************!*\
  !*** ./src/scripts/all_tournaments_block.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
jQuery(document).ready(function ($) {
  if ($('.iesf-all-tournaments-block').length > 0) {
    var api_url = window.location.origin + "/wp-json/iesf/v1/tournaments/posts";
    ...
    $('.iesf-all-tournaments-block .countdown').each(function () {
      ...
      var timeNow = moment__WEBPACK_IMPORTED_MODULE_0___default()().format('YYYY-MM-DD HH:mm:ss');
      if (moment__WEBPACK_IMPORTED_MODULE_0___default()($date).isBefore(timeNow)) {
        $this.html('Tournament has ended');
      } else {
        setInterval(function () {
          var timeNow = moment__WEBPACK_IMPORTED_MODULE_0___default()().format('YYYY-MM-DD HH:mm:ss');
          var diff = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(moment__WEBPACK_IMPORTED_MODULE_0___default()($date).diff(moment__WEBPACK_IMPORTED_MODULE_0___default()(timeNow)));
          var days = diff.days();
    ...
    $('.iesf-all-tournaments-block .filter-vals').on('submit', function (e) {
      ...
      var $game = $this.find('input[name="filter_games"]').val();
      var $region = $this.find('input[name="filter_region"]').val();
      var $country = $this.find('input[name="filter_country"]').val();
      var showPastTournaments = $this.find('input[name="show_past_tournaments"]').val();
      var $filter_page = $this.find('input[name="filter_page"]').val();
      ...
      axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(api_url, {
        params: $data
        ...
        var tournamentsMarkup = '';
        var paginationTotal = tournaments.total;
        // Check if we need pagination we need to have 9 posts per page
        if (paginationTotal > 9) {
          var pagination = '';
          var paginationTotalPages = Math.ceil(paginationTotal / 9);
        ...
        tournaments.tournaments.forEach(function (tournament) {
          var startTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(tournament.start_time).format('YYYY-MM-DD HH:mm:ss');
          var endTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(tournament.end_time).format('YYYY-MM-DD HH:mm:ss');
        ...
        var currentPageVal = $('.iesf-all-tournaments-block .filter-vals input[name="filter_page"]').val();
...
function tournament_card_component(bannerImgS, bannerImgM, bannerImgL, title, startTime, endTime, link) {
  var prettyStartTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(startTime).format('DD MMM');
  var prettyEndTime = moment__WEBPACK_IMPORTED_MODULE_0___default()(endTime).format('DD MMM');
  var endTimeMarkup = '';
  if (endTime) {
    endTimeMarkup = " - <span class=\"single-tournament-time-end\">".concat(prettyEndTime, "</span> ");
  }
  var imgMarkup = '';
  var srcset = '';
  var sizes = '';
  if (bannerImgS) {
    srcset += "".concat(bannerImgS, " 300w,");
    sizes += "(max-width: 600px) 300px,";
  }
  if (bannerImgL) {
    srcset += "".concat(bannerImgL, " 1200w,");
    sizes += "1200px,";
  }
  if (bannerImgM) {
    srcset += "".concat(bannerImgM, " 600w,");
    sizes += "(max-width: 600px) 600px,";
  }
  if (bannerImgS) {
    imgMarkup = "   <img class=\"single-tournament-banner\"\n        src=\"".concat(bannerImgS, "\"\n         srcset=\"").concat(srcset, "\"\n            sizes=\"").concat(sizes, "\"\n             alt=\"").concat(title, "\">\n        ");
  }
  return "\n    <div class=\"single-tournament single-tournament-card\">\n     ".concat(imgMarkup, "\n            <div class=\"wrap\">\n          \n                <div class=\"single-tournament-time\">\n                    <span class=\"single-tournament-time-start\">").concat(prettyStartTime, "</span> ").concat(endTimeMarkup, "\n                </div>\n                <h3 class=\"single-tournament-title\">").concat(title, "</h3>\n                <p class=\"countdown\" data-time=").concat(startTime, "\"><span></span></p>\n                <a href=\"").concat(link, "\" class=\"btn btn-clear btn-clear-arrow\">View More<span class=\"material-symbols-outlined\">\n                    arrow_right_alt\n                </span></a>\n        </div>\n   \n</div>\n    ");
}
...
/***/ "./src/scripts/single-tournament.js":
/*!******************************************!*\
  !*** ./src/scripts/single-tournament.js ***!
  \******************************************/
/***/ (() => {
...
jQuery(document).ready(function ($) {
  var stickyElement = $(".tournament-info-card");
  ...
  $('.single-tournaments .tabs-tab-header-item').on('click', function () {
    var targetEl = $(this).attr('data-tab');
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/admin","css/editor"], () => (__webpack_require__("./src/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/admin","css/editor"], () => (__webpack_require__("./src/app.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/admin","css/editor"], () => (__webpack_require__("./src/editor.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/admin","css/editor"], () => (__webpack_require__("./src/admin/style/admin.scss")))
