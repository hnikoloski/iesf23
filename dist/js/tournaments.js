...
"use strict";
/*!******************************************!*\
  !*** ./src/admin/scripts/tournaments.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/lib/axios.js");

jQuery(document).ready(function ($) {
  var api_url = window.location.origin + "/wp-json/iesf/v1/tournaments";
  $('.tournament-admin-data form').on('submit', function (e) {
    e.preventDefault();
    $(this).addClass('loading');
    var $form = $(this);
    var cm_pw = $(this).attr('data-cm-nonce');
    if (!cm_pw) {
      cm_pw = $(this).find('input[name="cm_pw"]').val();
    }
    var tournament_id = $(this).find('input[name="tournament_id"]').val();
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(api_url, {
      ...
      var postId = response.data.wp_id;
  ...
  $('.sync-tournament').on('click', function (e) {
    ...
    $(this).addClass('loading');
    var cm_pw = $('.tournament-admin-data #cm_pw').val();
    var tournament_id = $('.tournament-admin-data #tournament_id_hidden').val();
    ...
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(api_url, {
      ...
      // Count down
      var $countDown = $('.tournament-admin-notice p span');
      var count = 3;
      ...
      var $loadBar = $('.tournament-admin-notice .loadbar');
      var timeForLoadBar = 3000;
      var loadBarInterval = setInterval(function () {
        var currentWidth = $loadBar.width();
  ...
  $('.sync-team').on('click', function (e) {
    ...
    $(this).addClass('loading');
    var cm_pw = $('.tournament-admin-data #cm_pw').val();
    var members_id_hidden = $('.tournament-admin-data #members_id_hidden').val();
    var post_id = $('.tournament-admin-data #post_id_hidden').val();
    var team_id_hidden = $('.tournament-admin-data #team_id_hidden').val();
    $('.tournament-admin-data').addClass('loading');
    axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(api_url + '/import/players', {
      params: {
        cm_pw: cm_pw,
