...
// Add full width support to gutenberg
...
// Load ACF Options page and check if ACF is installed
...
// Middlewear
require get_template_directory() . '/inc/middlewear.php';

// Admin Pages
require get_template_directory() . '/inc/admin_pages.php';




// Add custom block category to gutenberg
add_filter('block_categories_all', 'iesf_block_categories_all', 10, 2);
function iesf_block_categories_all($categories, $post)
{
    return array_merge(
        $categories,
        array(
